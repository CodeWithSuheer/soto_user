  ...
  return (
    <>
      <section className="nav_main absolute top-0 w-full">
        {/* TOP LINE */}
        {showTopBar && (
          <div className="relative antialiased bg-black text-gray-100 text-center">
            <p className="py-2 text-sm tracking-wide font-normal">
        ...
        <header className="group bg-transparent hover:bg-gray-100 tracking-wide w-full z-50">
          ...
          {/* BOTTOM LINE */}
          <section className="flex flex-wrap justify-start px-10 pt-1 pb-4 relative">
            <div
            ...
            >
              ...
              <ul className="lg:flex lg:gap-x-7 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-2/3 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-4 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
                ...
                {navigation.map((data) => (
                  <li
                    key={data.id}
                    className="max-lg:border-b max-lg:px-0 max-lg:py-3"
                  >
                    <Link
                      className="text-gray-50 group-hover:text-black font-normal text-md block hover:underline hover:underline-offset-2"
                      to={`${data.path}`}
                    >
                      {data.title}
                    </Link>
            ...
            <div className="flex ml-auto lg:hidden" id="toggleOpen">
              <button>
                <svg
                  className="w-7 h-7"
                  fill="#000"
